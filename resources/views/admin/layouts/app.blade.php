    ...
    <div class="flex h-screen overflow-hidden relative">
        ...
        <aside 
            ...
            <div class="p-6 border-b border-slate-800 flex items-center justify-between lg:justify-center gap-3">
                ...
                <button @click="mobileSidebarOpen = false" class="lg:hidden text-slate-400 hover:text-white p-1 rounded-lg hover:bg-slate-800 cursor-pointer">
            ...
            <div class="p-4 border-t border-slate-800">
                <form action="{{ route('admin.logout') }}" method="POST">
                    ...
                    <button type="submit"
                        ...
                        <i class="ti ti-logout text-base group-hover:translate-x-0.5 transition-transform duration-200"></i>
                        Keluar / Logout
                    </button>
                </form>
            </div>
        ...
        <div class="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 lg:px-8 z-10 shadow-xs">
                
                <div class="flex items-center gap-3">
                    <button @click="mobileSidebarOpen = true" class="lg:hidden p-2 rounded-xl text-slate-600 hover:bg-slate-100 cursor-pointer transition-colors">
