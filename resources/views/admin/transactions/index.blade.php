                    ...
                    <tbody class="divide-y border-slate-100 text-sm font-medium text-slate-700">
                        @forelse($transactions as $transaction)
                            <tr class="hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="bg-slate-100 text-slate-700 px-2.5 py-1 rounded-md text-xs font-bold uppercase">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @else
                                        <span
                                            class="inline-flex items-center gap-1 bg-red-50 text-red-700 px-2.5 py-1 rounded-full text-xs font-semibold">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-slate-400">
                                    <div class="flex flex-col items-center justify-center space-y-2">
                                        ...
                                        <p class="text-sm font-normal text-slate-400">Riwayat donasi akan tercatat otomatis
                                            di sini setelah sistem API Midtrans terhubung.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
